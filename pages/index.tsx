...
const Home: React.FC = () => {
  return (
    <>
      ...
      <Flex bgColor='brand.400' h='100vh' overflow='hidden' align='center' flexDir='column'>
        <Flex flexDir='column' align='center'>
            ...
            <Flex backgroundColor='brand.300' w={['320px', '400px']} h={['390px', '400px']} mt='-180px' pt='190px' pb='10px' shadow='md' zIndex='50' borderRadius='md' flexDir='column' textAlign='center' align='center' >
              ...
              <Stack flexGrow={1} align='center' isInline spacing={8}>
                <Link href='https://instagram.com/leonunesbs' isExternal>
                  <Icon as={FiInstagram} color='brand.100' w={[8, 10]} h={[8, 10]} _hover={{color:'brand.500'}}/>
                </Link>
                <Link href='https://www.linkedin.com/in/leonardo-n-38001a100/' isExternal>
                  <Icon as={FaLinkedinIn} color='brand.100' w={[8, 10]} h={[8, 10]} _hover={{color:'brand.500'}}/>
                </Link>
      ...
      <Flex bgColor='brand.300' overflow='hidden' align='center' justify='space-around' flexDir='column'>
        ...
        <Flex wrap={['wrap', 'initial']} mb={4} w='100%'>
          ...
          <Flex flexDir='column' w='100%'>
            <Flex flexDir='column' mb={4}>
              ...
              <Stack overflowX='auto' pl={6} py={2} spacing='15px' isInline borderRadius='md'>
            ...
            <Flex flexDir='column' mb={4}>
              ...
              <Stack overflow='auto' pl={6} py={2} spacing='15px' isInline borderRadius='md'>
